...
const buildQuickApp = require('./buildQuickApp');
...
function build(options = {}) {
  ...
  compiler.run((err, stats) => {
    handleCompiled(err, stats, { skipClearStdout }, options);
...
function handleCompiled(err, stats, { skipClearStdout }, options) {
  if (err) {
  ...
  if (stats.hasErrors()) {
    ...
    // build quickapp directory
    buildQuickApp(options);
  }
}
